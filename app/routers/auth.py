...
from app.schemas.auth import LoginRequest, TokenResponse, UserInfoResponse, LoginResponse, UserProfileResponse
...
def login(login_data: LoginRequest, db: Session = Depends(get_db)):
    ...
    """
    return AuthService.login_user(db, login_data.username, login_data.password)
